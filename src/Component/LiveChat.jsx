...
const LiveChat = () => {
  ...
  return (
    <>
      ...
      <form className="w-full m-1 rounded-lg border border-gray-400 py-1" onSubmit={(e) => {
        e.preventDefault();
        ...
        <input className=" text-sm w-64 rounded-tl-lg rounded-bl-lg px-2 outline-none" type="text" placeholder="Live Chat" value={liveMsg} onChange={(e) => {setLiveMsg(e.target.value)}}
          />

        <button className=" w-16 rounded-md border border-gray-300 text-gray-500 text-sm ">Send</button>
